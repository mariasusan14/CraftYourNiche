...
const CollaborationPlatform = () => {
  ...
  const fetchCollaborationRequests = async () => {
    try {
      ...
      const collaborationRequestsSnapshot = await getDocs(useref);
      const requests = collaborationRequestsSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() }));
  ...
  const handleSubmitRequest = async (event) => {
    ...
    try {
      ...
      console.log(docRef);
      // Add a new document with the specified ID and data
